...
pencolor("black")
width(0.5)
write("Token 1:\nMitsubishi", align = 'left', font =('Arial',16,'normal'))

#define token 2 - susuki
...
pencolor("black")
width(0.5)
write("Token 2:\nSuzuki", align = 'left', font =('Arial',16,'normal'))
...
pencolor("black")
width(0.5)
write("Token 3:\nToyota", align = 'left', font =('Arial',16,'normal'))
...
pencolor("black")
width(0.5)
write("Token 4:\nVolkswagen", align = 'left', font =('Arial',16,'normal'))
...
#def permutation(column,token):

 #   if column=='a'


#for move in fixed_game_a8:
 #   if move[0]=='e':
  ##      e=[move[1]]
    #    print("won")
   # else:
...
#def winner_of_the_game(col4, token):
...
title("Car company logo (Mitsubishi, Suzuki, Toyota and Volkswagen)")
...
#play_game(fixed_game_a8) # <-- use this for code development only
